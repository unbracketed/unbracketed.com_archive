...
def category_detail(request, slug, **kwargs):
    ...
    * ``queryset`` will always be the ``QuerySet`` of live entries in
      the ``Category``.
    * ``template_name`` will always be 'article/category_detail.html'.
...
def category_archive_index(request, slug, **kwargs):
    ...
    * ``template_name`` will always be 'article/category_archive.html'.
    
    Template::
        article/category_archive.html
    ...
    return date_based.archive_index(request,
                                    queryset=category.live_entry_set,
                                    date_field='pub_date',
                                    template_name='article/category_archive.html',
                                    **kwarg_dict)
...
def category_archive_year(request, slug, year, **kwargs):
    ...
    * ``queryset`` will always be the ``QuerySet`` of live entries in
      the ``Category``.
    * ``date_field`` will always be 'pub_date'.
    * ``template_name`` will always be 'article/category_archive_year.html'.
    
    Template::
        article/category_archive_year.html
    ...
    return date_based.archive_year(request,
                                   ...
                                   queryset=category.live_entry_set,
                                   date_field='pub_date',
                                   template_name='article/category_archive_year.html',
                                   **kwarg_dict)
...
def category_archive_month(request, slug, year, month, **kwargs):
    ...
    * ``queryset`` will always be the ``QuerySet`` of live entries in
      the ``Category``.
    * ``date_field`` will always be 'pub_date'.
    * ``template_name`` will always be 'article/category_archive_month.html'.
    
    Template::
        article/category_archive_month.html
    ...
    return date_based.archive_month(request,
                                    ...
                                    queryset=category.live_entry_set,
                                    date_field='pub_date',
                                    template_name='article/category_archive_month.html',
                                    **kwarg_dict)
...
def category_archive_day(request, slug, year, month, day, **kwargs):
    ...
    * ``queryset`` will always be the ``QuerySet`` of live entries in
      the ``Category``.
    * ``date_field`` will always be 'pub_date'.
    * ``template_name`` will always be 'article/category_archive_day.html'.
    
    Template::
        article/category_archive_day.html
    ...
    return date_based.archive_day(request,
                                 ...
                                 queryset=category.live_entry_set,
                                 date_field='pub_date',
                                 template_name='article/category_archive_day.html',
                                 **kwarg_dict)
